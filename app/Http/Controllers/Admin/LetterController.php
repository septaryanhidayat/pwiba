...
class LetterController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'cq' => 'nullable|string|max:1000',
            'keperluan' => 'nullable|string',
            'perihal' => 'nullable|string|max:2000',
            'tempat_tujuan' => 'nullable|string|max:500',
            'nama_pejabat' => 'nullable|string|max:500',
            'jabatan_pejabat' => 'nullable|string|max:500',
