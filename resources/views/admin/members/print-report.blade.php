...
<div class="no-print mb-4 d-flex justify-content-between align-items-center bg-light p-3 border rounded-3 shadow-sm">
    <div>
...
<div class="container-fluid px-0" id="printReportContainer">
...
<script>
    function setPaperSize(size) {
        ...
        if (size === 'legal') {
            document.body.style.width = '216mm';
