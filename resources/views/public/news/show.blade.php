...
function shareTo(platform) {
    ...
    switch(platform) {
        ...
        case 'facebook':
            ...
            break;
        case 'instagram':
            copyNewsLink(null, 'Tautan disalin! Buka Instagram untuk membagikan.');
        ...
        case 'telegram':
            ...
            break;
        case 'threads':
            shareUrl = 'https://www.threads.net/intent/post?text=' + encodeURIComponent(title + ' ' + url);
            break;
    }
