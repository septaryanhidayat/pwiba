        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div class="max-w-3xl mx-auto sm:mx-0 flex flex-col items-center sm:items-start">
                <span class="text-xs font-bold uppercase tracking-wider text-amber-400 bg-white/10 px-3.5 py-1 rounded-full border border-white/15">
                    Dokumentasi Visual Jurnalistik
                </span>
                ...
                <p class="text-slate-300 text-sm sm:text-base mt-2">
                    Dokumentasi ragam aktivitas jurnalistik, peringatan Hari Pers Nasional, audiensi pemerintah daerah, dan momentum bersejarah PWI Kabupaten Banyuasin.
                </p>
            </div>
            <div class="shrink-0">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8 pb-4 border-b border-slate-200 dark:border-slate-800">
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 rounded-xl bg-blue-600/10 dark:bg-blue-600/20 text-blue-600 flex items-center justify-center font-bold">
                    <i class="fa-solid fa-images text-lg"></i>
                </div>
                <div>
                    <h2 class="text-xl font-extrabold text-[#0B132B] dark:text-white">
                        Daftar Foto Dokumentasi Resmi
                    </h2>
                    <p class="text-xs text-slate-500 dark:text-slate-400">Klik salah satu foto untuk memperbesar tampilan</p>
                </div>
            </div>
            <span class="text-xs font-bold text-slate-500 dark:text-slate-400 bg-slate-200/60 dark:bg-slate-900 px-3.5 py-1.5 rounded-xl border border-slate-300/60 dark:border-slate-800">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            @empty
                <div class="col-span-3 text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 text-slate-500">
