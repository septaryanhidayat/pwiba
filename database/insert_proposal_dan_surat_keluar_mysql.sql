...
-- 2. INSERT DOKUMEN 1: Surat Keluar Permohonan Sponsorship PT Pegadaian
INSERT INTO `letters` (
    `uuid`,
    `nomor_surat`,
    `tanggal`,
...
SELECT 
    ...
    'SURAT BIASA',
    'published',
    'Pemimpin Wilayah PT Pegadaian (Persero) Kanwil Sumbagsel',
    'Pemimpin Wilayah',
    'Pemimpin Wilayah PT Pegadaian',
    'Jl. Merdeka No. 11, Kota Palembang, Sumatera Selatan',
    'Palembang',
    'Permohonan Sponsorship / Dukungan Kerja Sama Seminar Sehari',
    'Permohonan Sponsorship / Dukungan Kerja Sama Seminar Sehari',
    ...
    'letters/095_PWI-BA_IX_2026_Surat_Sponsorship_Pegadaian.docx',
    'Wardoyo, S.I.Kom',
    'Deni Arianto',
    'valid',
    SHA2('095/PWI-BA/IX/2026|2026-09-10|PWI-BANYUASIN-PEGADAIAN', 256),
    NOW(),
    NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM `letters` WHERE `nomor_surat` = '095/PWI-BA/IX/2026'
);

-- 3. INSERT DOKUMEN 2: Proposal Lengkap Seminar Sehari AI (RAB & Susunan Panitia)
INSERT INTO `letters` (
    `uuid`,
    `nomor_surat`,
    `tanggal`,
...
SELECT 
    ...
    'Seminar Sehari: Jurnalisme Cerdas di Era AI',
    'RAB & Susunan Panitia',
